...
const Setting = (props: AllWidgetSettingProps<IMConfig>) => {
      ...
      <React.Fragment>
        ...
        <SettingSection title={shareOption} aria-label={shareOption} role='group'>
          <ItemsSelector
            ...
            onEmailContentClick={handleOpenEmailSetting}
          />
        </SettingSection>
  ...
  const renderInlineModeSetting = () => {
    ...
    const iconColor = props.intl.formatMessage({ id: 'iconColor', defaultMessage: commonMessages.iconColor })
  ...
  const handleOpenEmailSetting = (target: EventTarget) => {
    // Prevent reopening if closed very recently (enter key lingering)
